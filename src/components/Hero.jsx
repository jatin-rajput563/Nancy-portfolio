...
const Hero = () => {
  ...
  overflow-hidden group hover:scale-110 hover:shadow-[0_0_25px_#A53DFF] rounded-[4px]"
    ...
    translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out"
          ...
          <div className="shadow-2xl p-[112px] rounded-[16px]">
            <div className="flex flex-row flex-wrap -mx-3">
              <div className="w-full lg:w-1/2 px-3 mb-6">
                <div className="relative">
                  <img className="w-full max-w-[424px]" src={UserImg} alt="user-img" />
              ...
              <div className="w-full lg:w-1/2 px-3 mb-6">
                <div className="mt-[54px]">
                  ...
                  <p className="m-0 text-[18px] leading-[24px] max-w-[536px] text-[#556070] pt-[32px]">
                    I design clean and user-friendly websites, mobile apps, and
                    dashboards that make complex tasks simple and easy to use.
                    My focus is on creating smooth, engaging experiences that
                    work well for real users. <br />
                    <br />
                    As a designer, I turn ideas into clear, functional designs
                    that users love. I believe good design is simple, smart, and
